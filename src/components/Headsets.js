...
const Headsets = () => {
  ...
  <section className='py-12 lg:py-24'>
    <div className='container mx-auto'>
      {/* title */}
      <h2 className='text-3xl font-bold mb-6' data-aos='fade-down' data-aos-offest='300'>Mixed Reality Headset</h2>
      {/* grid */} 
      <div className='grid gap-y-4 lg:grid-cols-2 lg:gap-9'>
        {/* item */}
        <div className='relative' data-aos='zoom-in' data-aos-offest='300' data-aos-delay='1000'>
          ...
          <div className='absolute bottom-0 bg-white/20 backdrop-blur-md max-w-[300px] min-h-[150px] p-6'>
            ...
            <p >
              ...
              aspernatur commodi dolor laborum soluta
              omnis.
            </p>
          </div>
        </div>
        {/* item */}
        <div className='relative' data-aos='zoom-in' data-aos-offest='300' data-aos-delay='1300' >
        ...
        {/* item */}
        <div className='relative' data-aos='zoom-in' data-aos-offest='300' data-aos-delay='1600'>
        ...
        {/* item */}
        <div className='relative' data-aos='zoom-in' data-aos-offest='300' data-aos-delay='1900'>
